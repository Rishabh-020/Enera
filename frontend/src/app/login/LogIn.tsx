...
const ROLE_PASSWORDS: Readonly<Record<Role, string>> = {
...
const PARTICLES: readonly ParticleConfig[] = [
  ...
  { left: "5%", size: 9, dur: "15s", delay: "0.9s", color: "rgba(255,255,208,0.20)" },
...
function getDestinationRoute(user: User): string {
  switch (user.role) {
    case "RESIDENT":
      return `/flat/${user.flatId || ""}`;
    case "SOCIETY_ADMIN":
      return `/society/${user.societyId || ""}`;
    case "BUILDER_ADMIN":
      return `/builder/${user.builderId || ""}`;
    case "SUPER_ADMIN":
        ...
        <div className="relative z-10 flex flex-col h-full px-12 py-10">
          ...
          <div className="flex items-center gap-3 mb-auto">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-white/20 backdrop-blur-sm border border-white/30">
              <img src="/efficiency.png" alt="Enera logo" className="h-6 w-6 object-contain" />
            </div>
                ...
                return (
                  ...
                  >
                    <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-white/15 border border-white/20 mt-0.5">
                      <IconComponent size={18} className="text-teal-200" aria-hidden="true" />
                    </div>
                    <div>
      ...
      <div className="flex flex-1 lg:w-[45%] items-center justify-center bg-[#f4f5f8] px-4 py-12 relative">
        ...
        <div className="absolute top-6 left-0 right-0 flex justify-center lg:hidden">
          <div className="flex items-center gap-2.5">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-teal-500">
              <img src="/efficiency.png" alt="Enera logo" className="h-5 w-5 object-contain" />
            </div>
        ...
        <div className="relative w-full max-w-[400px]">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-200/60">
            ...
            {/* Role selector */}
            <p id="role-selector-label" className="text-[11px] font-semibold uppercase tracking-widest text-slate-400 mb-3">
              Sign in as
            </p>
            <div
              role="radiogroup"
              ...
              {ROLES.map((r) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "flex flex-col items-center gap-1.5 rounded-xl border-2 py-3 px-2 transition-all duration-200 cursor-pointer group focus:outline-none focus:ring-2 focus:ring-teal-500/20",
                      isSelected
          ...
          {/* Footer note */}
          <p className="mt-5 text-center text-[11px] text-slate-400">
            Enera · Smart IoT Energy Platform · v0.0.7
          </p>
        </div>
      </div>
    </div>
